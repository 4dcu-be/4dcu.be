...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to 4DCu.be.
...
- __Website__ refers to 4DCu.be, accessible from [blog.4dcu.be](https://blog.4dcu.be)
...
If you have any questions about this Privacy Policy, You can contact Us through channels listed under contact on [blog.4dcu.be](https://blog.4dcu.be).
