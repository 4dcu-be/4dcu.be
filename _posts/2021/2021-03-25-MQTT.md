...
description: "How to add Aqara Zigbee sensors to Home Assistant via Zigbee2MQTT to monitor temperature, humidity and air pressure, including pairing and config."
