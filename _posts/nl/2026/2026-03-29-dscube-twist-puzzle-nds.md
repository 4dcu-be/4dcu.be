...
byline: "Een homebrewproject voor de Nintendo DS reanimeren met Claude Code en Gemini"
description: "DSCube, een twintig jaar oud homebrewproject rond Rubiks kubus voor de Nintendo DS, weer tot leven wekken met Claude Code en Gemini, en met devkitPro en Docker opnieuw aan de praat krijgen."
...
oplossen. Dus deed ik wat elke nerd met een beetje zelfrespect zou doen: ik schreef een simulator van Rubiks kubus
...
niet uit pure nostalgie, maar om te zien hoe ver AI-ondersteunde ontwikkeling een project kon brengen waarvoor ik nooit
de tijd of de grafische vaardigheden had gehad om het af te werken tot iets waar ik echt tevreden over was. Het resultaat is
...
Spoel door naar 2026. Ik verken hoe AI-ondersteund programmeren hobbyprojecten naar een niveau kan tillen dat
ik alleen niet bereik, of het nu gaat om [een genetisch kunstalgoritme naar Rust porten] of [een Game Boy-game vanaf nul bouwen]. Elk project leert me iets nieuws over waar AI uitblinkt en waar menselijk oordeel nog altijd
onmisbaar is.
...
De eerste prioriteit was het project betrouwbaar aan de praat krijgen. De NDS-toolchain is sinds het midden van de jaren 2000
...
Mijn workflow met Claude Code volgt een patroon dat ik in verschillende projecten heb verfijnd. Eerst werk
...
volwaardig UI-systeem op basis van knoppen dat zowel touch- als D-padnavigatie ondersteunt:
...
Elke pixel wordt in een 16-bit word gepakt met 5 bits per kanaal en een alphabit. Die `.bin`-bestanden worden vervolgens
...
## Toen versus nu: hoe ontwikkeling veranderd is

Werken aan dit project in 2026 in plaats van in 2007 is een heel andere ervaring. Dit viel me op:
...
het algoritme om te detecteren of een 4x4 opgelost is, en de camerawiskunde: dat vergde evenveel zorgvuldig
denkwerk als vroeger. AI kan helpen bij het implementeren van een oplossing zodra je die hebt ontworpen, maar dat
...
Het is een vreemd gevoel om dit project eindelijk afgewerkt te zien. Twintig jaar geleden zette ik het in de kast
omdat het leven (en een doctoraatsthesis) ertussen kwam. De kernlogica was altijd al in orde; het project had gewoon meer
...
[een genetisch kunstalgoritme naar Rust porten]: {% post_url nl/2025/2025-12-20-rust-experiment %}
[een Game Boy-game vanaf nul bouwen]: {% post_url nl/2026/2026-03-15-gameboy-royal-game-of-ur %}
