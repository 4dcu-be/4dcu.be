...
description: "3D printing tips and tricks for the Creality CR10S, covering PLA and PETG settings, a glass-to-mirror bed swap, Marlin firmware and Cura profile tweaks."
...
There are a couple filaments I frequently use, plain PLA, woodfill PLA and PETG. They all need different settings to
...
All these materials require slightly different settings. Below I'll list the settings that work well for me (using
...
build plate easily and has a nice glossy, smooth finish even at the default layer height of 0.2 mm. The downside is that
...
sandpaper, to hide the layer lines, but there is no need to sand them out completely. Then I'll apply some
...
3D printing is a slow process, for larger prints I use a wider nozzle, 0.6 mm. This has three main advantages: you can
get away with fewer perimeters, areas are filled faster, and the maximum layer height can be increased. However, to print
