...
byline: ""
description: "How to add fast full-text search to a static website with Pagefind, which crawls your generated pages to build an index served by a small bit of JavaScript."
